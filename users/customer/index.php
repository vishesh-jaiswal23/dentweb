      ...
      <section class="section" style="padding:3rem 0 2rem;">
        <div class="container">
          <div class="head">
            ...
            <h1>Hello, <?php echo htmlspecialchars($user['name'] ?? 'Customer'); ?></h1>
            <p class="sub">Customer workspace (empty state). Features coming soon.</p>
          </div>

          <div class="card" style="padding:1.5rem; margin-top:1rem;">
            <p>We will add project tracking, subsidy docs, and support.</p>
          </div>
